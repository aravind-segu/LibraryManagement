...
public class authorsearch extends LibraryManagement implements ActionListener {
        /*
  ...
  static ArrayList <String> bookArray = new ArrayList<> ();
        ...
        */
			...
			resultSet = statement.executeQuery("SELECT ID,BookTitle,Author,Year,Publisher,Pages,BookID,Copies,CopiesChecked,ShelfNumber,Available FROM BookDetails");
                        ...
                        * The while loop iterates through each row of Table, BookDetails
                             ...
                             * An if loop determines if the input Text of user matches the Author of the data
			...
			while (resultSet.next()) {
                                ...
                                String authorl = author.toLowerCase();
                                String inputl = inputField.toLowerCase();
                        if (authorl.contains (inputl)){
   ...
   if (found == true){
       ...
       */
                        }else {JOptionPane.showMessageDialog(null, "Author not found" );
                        new search ();}
         }catch (Exception e){
