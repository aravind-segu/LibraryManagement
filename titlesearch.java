...
public class titlesearch extends LibraryManagement implements ActionListener{
        /*
   ...
   public void GUI (){
	...
	resultSet = statement.executeQuery("SELECT ID,BookTitle,Author,Year,Publisher,Pages,BookID,Copies,CopiesChecked,ShelfNumber,Available FROM BookDetails");
			...
			while (resultSet.next()) {
                     ...
                     //   if (inputField.equals (book)){
                        if (bookl.contains(inputl)){
...
*/
                        }else {JOptionPane.showMessageDialog(null, "Title not found" );
                        new search ();}
         }catch (Exception e){
