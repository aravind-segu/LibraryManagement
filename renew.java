...
public class renew extends LibraryManagement implements ActionListener {
    /*
			...
			while (resultSet.next()) {
                        ...
                        */
                        ...
                        if (foundmem == false & foundbook == true){
                            JOptionPane.showMessageDialog(null, "MemberID: " + idmem + " not found. or This Member did not Check-Out Book:"+ idInput );
                            new renew ();
                            renewFrame.dispose();
                        }
